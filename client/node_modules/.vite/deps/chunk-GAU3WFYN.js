...
var AssignmentExpression = class extends NodeBase {
  hasEffects(context) {
    ...
    if (!deoptimized)
      this.applyDeoptimizations();
    return right.hasEffects(context) || left.hasEffectsAsAssignmentTarget(context, operator !== "=") || this.left.hasEffectsWhenDestructuring?.(context, EMPTY_PATH, right);
  }
  hasEffectsOnInteractionAtPath(path, interaction, context) {
  ...
  include(context, includeChildrenRecursively) {
    ...
    if (includeChildrenRecursively || operator !== "=" || left.included || left.hasEffectsAsAssignmentTarget(hasEffectsContext, false) || left.hasEffectsWhenDestructuring?.(hasEffectsContext, EMPTY_PATH, right)) {
...
async function watchInternal(configs, emitter) {
  ...
  await loadFsEvents();
  const { Watcher } = await import("./watch-CT7OIQES.js");
...
rollup/dist/es/shared/node-entry.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-GAU3WFYN.js.map
