...
function usePulsy(name) {
    ...
    var setter = react.useCallback(function (newValue) { return __awaiter(_this, void 0, void 0, function () {
        var setter;
    ...
    var memoizedValue = react.useMemo(function () { return value; }, [value, (_a = storeRef.current) === null || _a === void 0 ? void 0 : _a.memoize]);
...
function useTimeTravel(name) {
    ...
    var updateValue = react.useCallback(function (newValue) { return __awaiter(_this, void 0, void 0, function () {
        var updatedValue;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
exports.clearPersistedStores = clearPersistedStores;
exports.composeStores = composeStores;
exports.configurePulsy = configurePulsy;
exports.createActions = createActions;
exports.createComputedStore = createComputedStore;
exports.createNamespacedStore = createNamespacedStore;
exports.createSetter = createSetter;
exports.createStore = createStore;
exports.default = usePulsy;
exports.devTools = devTools;
exports.getStoreValue = getStoreValue;
exports.initializePulsy = initializePulsy;
exports.setStoreValue = setStoreValue;
exports.usePulsy = usePulsy;
exports.useTimeTravel = useTimeTravel;
